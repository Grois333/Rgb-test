<?php
/**
* Plugin Name: WP Cookies Management
* Description: This plugin is a Wordpress cookies management system.
...
add_shortcode('wp_dynamic_cookie_manger', 'wp_dynamic_cookie_management');
function wp_dynamic_cookie_management(){
    ob_start();
